...
public class DetailService {
    ...
    private static List<Details> details = Arrays.asList(
            new Details(1, "William Shakespeare", 1595, "paperback", 200, "PublisherA",
    ...
    public Optional<Details> getDetailById(int id) {
